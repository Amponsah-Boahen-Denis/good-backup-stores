export type ProductCategoryInfo = { category: string; googleTypes: string[] } | null;

export function getProductCategory(productName: string): ProductCategoryInfo {
  const categoryMap: Record<string, { keywords: string[]; googleTypes: string[] }> = {
    electronics: {
